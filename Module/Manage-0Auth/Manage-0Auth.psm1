...
#>
    ...
    $0authlink = "https://accounts.google.com/o/oauth2/auth?client_id=" + $ClientID + "&scope=" + $Scope + "&response_type=code&redirect_uri=" + $RedirectURI + "&access_type=offline&approval_prompt=force"
